...
)
{
    ...
    zero [0] = 0 ;
    zero [1] = 0 ;
    return (CHOLMOD(factorize2_p) (A, zero, NULL, 0, L, Common)) ;
}
...
)
{
	...
	if (Common->status == CHOLMOD_OK)
	{
	    ...
	    CHOLMOD(rowfac2) (S, F, beta, 0, nrow, L, Common) ;
	    Common->grow2 = grow2 ;
	}
	status = Common->status ;
...
/* ========================================================================== */
/* === cholmod_factorize2_p ================================================== */
/* ========================================================================== */

/* Same as cholmod_factorize2, but with more options. */

int CHOLMOD(factorize2_p)
(
    /* ---- input ---- */
    cholmod_sparse *A,	/* matrix to factorize */
    double beta [2],	/* factorize beta*I+A or beta*I+A'*A */
